...
class EM_Gateway {
	...
	function get_payment_return_url(){
		/* 
		 * reverted back in 2.4.4.5 to old notification url due to PayPal fixing the issue. Permalinks may themselves present different problems and break installations that were previously fine.
		 * permalink return url detection has still been left in place for those payments that were made before updating
		 */
