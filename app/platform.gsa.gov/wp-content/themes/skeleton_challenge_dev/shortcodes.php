...
function challenge_display_posts_shortcode( $atts ) {
	...
	while ( $listing->have_posts() ): $listing->the_post(); global $post;
		...
		$output = '<div class="front-challenge-item-container">'.$edit_link.'<' . $inner_wrapper . ' class="' . implode( ' ', $class ) . '">'.'<a ' .($where_host == "remote" ? " target=\"_blank\"" : ""). 'class="challenge-title" href="' . $link_out . '"><img src="'.$logo_in.'" class="front-challenge-img"></a><div class="front-challenge-innertext">' . $image . $title . $posted_by . $tagline_text . $date . $excerpt . $content . $rating . '</div></' . $inner_wrapper . '>';
