...
<div class="form-group subform-group">
	<div class="event-attributes">
		...
		<select class="form-control" name="em_attributes[<?php echo $name ?>]">
		...
		<input class="form-control" type="text" name="em_attributes[<?php echo $name ?>]" value="<?php echo array_key_exists($name, $EM_Event->event_attributes) ? esc_attr($EM_Event->event_attributes[$name], ENT_QUOTES):''; ?>" value="<?php echo $default_value; ?>" />
		<?php endif; ?>
	</div>
    </div>
	<?php endforeach; ?>
