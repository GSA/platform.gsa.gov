...
<table class="em-calendar">
	<thead>
		<tr>
			<td class="cal-nav"><a class="em-calnav em-calnav-prev" href="<?php echo $calendar['links']['previous_url']; ?>" rel="nofollow"><i class="fa fa-arrow-circle-left"></i></a></td>
			...
			<td class="cal-nav"><a class="em-calnav em-calnav-next" href="<?php echo $calendar['links']['next_url']; ?>" rel="nofollow"><i class="fa fa-arrow-circle-right"></i></a></td>
		</tr>
	</thead>
	<tbody>
		<tr class="days-names">
