...
<table class="em-calendar fullcalendar">
	<thead>
		<tr>
			<td class="cal-nav"><a class="em-calnav full-link em-calnav-prev" href="<?php echo $calendar['links']['previous_url']; ?>"><i class="fa fa-arrow-circle-left"></i></a></td>
			...
			<td class="cal-nav"><a class="em-calnav full-link em-calnav-next" href="<?php echo $calendar['links']['next_url']; ?>"><i class="fa fa-arrow-circle-right"></i></a></td>
		</tr>
	</thead>
	<tbody>
		<tr class="days-names">
		...
		<tr>
			...
			foreach($calendar['cells'] as $date => $cell_data ){
				...
				?>
				<td class="<?php echo $class; ?> displaytooltip">
					...
					<ul class="tooltip-help">
						...
						<li class="tooltip-inner"><a href="<?php echo esc_url($cell_data['link']); ?>"><?php echo get_option('dbem_display_calendar_events_limit_msg'); ?></a></li>
						<?php endif; ?>
					</ul>
					<?php else:?>
