    ...
    if((empty($edit_var) || $edit_var != 'true') && (empty($edit_var2) || $edit_var2 != 'true')) {
        ...
        <?php while (have_posts()) : the_post(); ?>
            ...
            if ($where_host == "remote") {
                ...
                print '<div class="external_challenge">This is an external challenge hosted at: <a class="external_link_path" target="_blank" href="' . (($pos === 0 || $pos1 === 0)? $ext_url : "http://".$ext_url) . '">' . $external_url . '</a></div>';
			...
			switch($thiscat)
                ...
                <div class="challenge-top">
                    ...
                    <div class="challenge-top-text">
                        <?php echo !empty($agencies) ? '<span class="challenge-posted-by">Posted By: ' . $agencies . $partners . $challenge_cat_output . '</span>' : ''; ?>
<?php echo !empty($partner_agency) ? '<br><span class="challenge-posted-by">Partnership With: '.$partner_agency_title. '</span>' :''; ?>
                ...
                <li id="t2Tab" style="text-align:center;">
                    <div class="challenge-rules">
                        <span class="agency-challenges-header-discussions">Discussions</span>

                        <?php comments_template(); ?></div></li>
                <li id="t3Tab">
                    <div class="challenge-solutions">
                        <span class="agency-challenges-header">Solutions</span>
                        <?php
                        if ($solution_count > 0)
