...
if ( function_exists( 'add_image_size' ) ) { 
	add_image_size('narrow-featured-image-full', 630, 275, true); 
	add_image_size('narrow-featured-image', 315, 275, true);
	add_image_size('wide-featured-image-full', 960, 300, true); 
	add_image_size('wide-featured-image', 480, 300, true);
}
