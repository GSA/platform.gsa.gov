...
/*-----------------------------------------------------------------------------------*/
	...
	$options[] = array(
			...
			"std" => "",
			"type" => "select",
			"options" => array("","0px","1px","2px","3px","4px","5px","6px","7px","8px","9px","10px","11px","12px","13px","14px","15px","16px","17px","18px","19px","20px"),
...
<div id="settings-wrap" class="clearfix">
	...
	<ul class="tabs">
		<li><a href="#welcome">Theme Welcome</a></li>
	...
	<div id="welcome" class="content">
		...
		<div style="background:#f5f5f5;border:1px solid #e5e5e5;padding:20px 20px 0;margin-bottom:20px;">
			...
			<div class="help2">
				<p><?php _e("If you're installing this theme for the first time, you'll need to regenerate your post thumbnails and featured content images (you only have to do this once).", "solostream"); ?></p>
