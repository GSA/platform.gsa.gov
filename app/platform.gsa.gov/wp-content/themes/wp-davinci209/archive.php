	...
	<div id="page" class="clearfix">
		...
		<div id="contentleft" class="maincontent">
			...
			<div id="content" class="clearfix">
				...
				<?php if (is_category()) { ?>			
				<h1 class="archive-title"><a title="<?php _e("RSS Feed for the"); ?> '<?php echo single_cat_title(); ?>' <?php _e("Category"); ?>" href="<?php echo get_category_link($cat); ?>feed"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/FeedIcon-16.png" alt="<?php _e("RSS"); ?>" title="<?php _e("RSS Feed for the"); ?> '<?php echo single_cat_title(); ?>' <?php _e("Category"); ?>" style="float:left;padding-top:3px;margin-right:5px;" /></a><?php _e("Category", "solostream"); ?>: <?php echo single_cat_title(); ?></h1>		
				<?php } elseif (is_day()) { ?>
