...
/*-----------------------------------------------------------------------------------*/
	...
	if ( $page_box_shadow == "Yes" )
		$wrapper .= 'box-shadow:0px 0px 3px rgba(0,0,0,.2);-moz-box-shadow:0px 0px 3px rgba(0,0,0,.2);-webkit-box-shadow:0px 0px 3px rgba(0,0,0,.2);';
...
/*-----------------------------------------------------------------------------------*/
	...
	if ( $post_title_font )
		$output .= 'h1,h2,h3,h4,h5,h6,h7,#sitetitle .title {font-family:'.$post_title_font.';font-weight:'.$post_title_weight.' !important;}' . "\n";
	if ( $post_title_weight )
		$output .= 'h1,h2,h3,h4,h5,h6,h7,#sitetitle .title {font-weight:'.$post_title_weight.' !important;}' . "\n";
...
/*-----------------------------------------------------------------------------------*/
	...
	if ( $topnav_bg_color )
		$output .= '#topnav {border:0;}'. "\n";
	if ( $topnav_bg_color )
		$output .= '#topnav ul ul,#topnav ul ul a {border-color:#fff;}'. "\n";
	if ( $topnav_bg_color )
		$output .= '#topnav ul li.searchform {padding-right:4px;padding-left:4px;}'. "\n";
...
/*-----------------------------------------------------------------------------------*/
	...
	if ( $catnav_bg_color )
		$output .= '#catnav {border:0;} #catnav ul ul,#catnav ul ul a {border-color:#fff;}'. "\n";
...
/*-----------------------------------------------------------------------------------*/
	...
	if ( $button_bg )
		$output .= '#commentform input#submit,.archive-tabs a,.archive-tabs a:link,.archive-tabs a:visited,a.more-link,a.more-link:link,a.more-link:visited,#searchform #submitbutton,p.email-form .subbutton,a.comment-reply-link,a.comment-reply-link:link,a.comment-reply-link:visited {border-color:'.$button_bg.';background-color:'.$button_bg.';}' . "\n";
	if ( $button_font )
		$output .= '#commentform input#submit,.archive-tabs a,.archive-tabs a:link,.archive-tabs a:visited,a.more-link,a.more-link:link,a.more-link:visited,#searchform #submitbutton,p.email-form .subbutton,a.comment-reply-link,a.comment-reply-link:link,a.comment-reply-link:visited {color:'.$button_font.';}' . "\n";
	if ( $button_hover_bg )
		$output .= '#commentform input#submit:hover,.archive-tabs a:hover,.archive-tabs a:active,.archive-tabs .ui-tabs-selected a,a.more-link:hover,a.more-link:active,#searchform #submitbutton:hover,p.email-form .subbutton:hover,a.comment-reply-link:hover,a.comment-reply-link:active {border-color:'.$button_hover_bg.';background-color:'.$button_hover_bg.';}' . "\n";
	if ( $button_hover_font )
		$output .= '#commentform input#submit:hover,.archive-tabs a:hover,.archive-tabs a:active,.archive-tabs .ui-tabs-selected a,a.more-link:hover,a.more-link:active,#searchform #submitbutton:hover,p.email-form .subbutton:hover,a.comment-reply-link:hover,a.comment-reply-link:active {color:'.$button_hover_font.';}' . "\n";
