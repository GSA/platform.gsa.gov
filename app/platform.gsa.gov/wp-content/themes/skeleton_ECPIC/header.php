...
<link rel="shortcut icon" href="https://www.ecpic.gov/files/2013/04/favicon.png">
...
jQuery(function() {
	jQuery("img").each(function() {
		if(jQuery(this).attr('src').indexOf("http://ecpic.gov") > -1)
			jQuery(this).attr('src', jQuery(this).attr('src').replace('http://ecpic.gov', "https://www.ecpic.gov"));
	});
});
</script>
